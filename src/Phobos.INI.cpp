...
bool Phobos::Config::RightClickCommand = true;
bool Phobos::Config::TypeSelectByMultiClick = true;
...
DEFINE_HOOK(0x5FACDF, OptionsClass_LoadSettings_LoadPhobosSettings, 0x5)
{
	...
	Phobos::Config::RightClickCommand = CCINIClass::INI_RA2MD.ReadBool("Phobos", "RightClickCommand", true);
	Phobos::Config::TypeSelectByMultiClick = CCINIClass::INI_RA2MD.ReadBool("Phobos", "TypeSelectByMultiClick", true);
